...
const hero2Style = {
    backgroundImage: `url(${require('../img/hero-2.jpg')})`
};
...
export default function Home() {
    ...
    return (
      <>
        ...
        <li class="nav-item">
            <form id="side-search-open" class="nav-link" action="/search">
                <input type="text" name="key" />
                <button class="btn-search" type='submit'><span class="lnr lnr-magnifier"></span></button>
            </form>
        </li>
        </ul>
        </div>
        ...
        <h1 class="display-4 mb-5">We Love <br/>Travel!</h1>
        <div class="mb-2">
        ...
        <div class="item">
        <img class="img-fluid" src={require("../img/hero-1.jpg")} alt=""/>
        </div>
        <div class="item">
        <img class="img-fluid" src={require("../img/hero-2.jpg")} alt=""/>
        </div>
        <div class="item">
        <img class="img-fluid" src={require("../img/hero-3.jpg")} alt=""/>
        </div>
        </div>
        </div>
        </div>
        ...
        <div class="row">
        <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2" style={hero2Style}>
        ...
        <img class="img-fluid img-cover" src={require("../img/hero-1.jpg")} />
        ...
        <img class="img-fluid" src={require("../img/breakfast-1.jpg")} alt="" />
        </div>
        <div class="text-wrap">
        ...
        <img class="img-fluid" src={require("../img/chef-1.jpg")} alt="" />
        <div class="team-desc">
        ...
        <div class="col-md-4">
        <div class="team-card mb-5">
        <img class="img-fluid" src={require("../img/chef-2.jpg")} alt=""/>
        <div class="team-desc">
        ...
        <div class="col-md-4">
        <div class="team-card mb-5">
        <img class="img-fluid" src={require("../img/chef-3.jpg")} alt=""/>
        <div class="team-desc">
